  ...
  <div className="max-w-7xl mx-auto space-y-8">
    ...
    <div className="flex items-center justify-between gap-4">
      <div className="flex items-start gap-4">
        <div className="p-2.5 bg-violet-600 text-white rounded-xl shadow-inner">
          <svg className="w-7 h-7" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            <path d="M6 12h.01M9 12h.01M15 10l-2 4m1 1l2-4m-10 6h12a3 3 0 003-3V7a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"/>
          </svg>
        </div>
        <div className="space-y-1">
          <h1 className="text-3xl font-bold text-gray-950">โปรเจคของฉัน</h1>
          <p className="text-base text-gray-500">เลือกเกมที่ต้องการแก้ไข</p>
        </div>
      </div>
      <Link to="/CreateProject">
      <button className="inline-flex items-center gap-2.5 px-6 py-3 bg-violet-600 text-white rounded-xl font-medium text-lg hover:bg-violet-700 transition duration-150 shadow-sm shrink-0">
    ...
    <div className="flex flex-col items-center justify-center text-center bg-white border border-gray-100 rounded-3xl p-10 min-h-125">
