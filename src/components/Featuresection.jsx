...
const features = [
  { title: "จัดการบทเนื้อเรื่อง", desc: "สร้างและแก้ไขบทพูด ฉาก ตัวละคร", icon: "📚" },
  { title: "คลัง Asset", desc: "อัปโหลดและจัดการไฟล์ภาพพื้นหลัง", icon: "🎵" },
  { title: "หลายโปรเจกต์", desc: "รองรับการทำงานหลายเกมพร้อมกัน", icon: "👥" },
  { title: "Export พร้อมใช้", desc: "นำเข้า/ส่งออกข้อมูลผ่าน JSON ", icon: "⚡" },
];
...
const Featuresection = () => (
  <section className="py-20 px-8 max-w-7xl mx-auto">
    <div className="text-center mb-16">
      ...
      <p className="text-gray-500">ฟีเจอร์ครบสำหรับการพัฒนา Visual Novel ด้วย RenPy</p>
    </div>
